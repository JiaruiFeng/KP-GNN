...
def main():
    ...
    parser.add_argument("--kernel",type=str,default="spd",choices=("gd","spd"),help="The kernel used for K-hop neighbors extraction")
    ...
    parser.add_argument("--max_pe_num",type=int,default=1,help="Maximum number of path encoding. Must be equal to or greater than 1")
