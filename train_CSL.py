...
def main():
    ...
    for fold, (train_idx, test_idx, val_idx) in enumerate(
        ...
        val_loader = DataLoader(val_dataset, batch_size=args.batch_size,collate_fn=PyG_collate, num_workers=args.num_workers)
        test_loader = DataLoader(test_dataset, batch_size=args.batch_size,collate_fn=PyG_collate, num_workers=args.num_workers)
        train_loader = DataLoader(train_dataset, batch_size=args.batch_size, shuffle=True,collate_fn=PyG_collate, num_workers=args.num_workers)
